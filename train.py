...
from transformers import ElectraModel, ElectraTokenizer, AutoTokenizer, AutoConfig, AutoModelForSequenceClassification, Trainer, TrainingArguments, RobertaConfig, RobertaTokenizer, RobertaForSequenceClassification, BertTokenizer
from load_data import *
import wandb
import argparse

# wandb.init(project="nlp_level2", entity="ssgyejin")
...
def train(args):
  ...
  for fold_index, (train_index, eval_index) in enumerate(startifiedFold.split(X=train_dataset, y=train_label)):
    ...
    RE_dev_dataset = RE_Dataset(tokenized_dev, eval_label)
    ...
    training_args = TrainingArguments(
      output_dir=f'./results/{fold_index}',          # output directory
...
if __name__ == '__main__':
  os.environ['WANDB_API_KEY'] = '474ad8c49db45ffa138dcae91410d5a2ff4ffad1'
  os.environ['WANDB_ENTITY'] = 'plzanswer'
  os.environ['WANDB_PROJECT'] = 'test-project'
  os.environ['WANDB_LOG_MODEL'] = 'Ture'
